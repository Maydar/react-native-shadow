...
class SvgBorder extends PureComponent {
  static propTypes = {
    ...
    x: PropTypes.number,
    y: PropTypes.number,
    linear: PropTypes.func,
    radial: PropTypes.func,
  };
...
export default class BoxShadow extends PureComponent {
  static propTypes = {
  ...
  _getRadial = (color, opacity, radius, lineWidth) => {
    return (key) => {
      return [
  ...
  render() {
    ...
    const radial = this._getRadial(color, opacity, radius, lineWidth);
